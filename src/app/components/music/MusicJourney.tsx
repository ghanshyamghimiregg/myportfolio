...
const MILESTONES = [
  ...
  {
    year: '2023',
    title: 'First official releases',
    description: 'Released "Timro Yaad" and "Pharkera Aau". Small audience, massive learning curve. I discovered that releasing music is as vulnerable as performing it.',
    tag: 'Releases',
    icon: '◉',
  },
  {
    year: '2024',
    title: 'Live shows and collaborations',
    description: 'Performed at multiple events in Kathmandu. Began collaborating with other musicians and experimenting with production beyond just acoustic guitar.',
    tag: 'Performance',
    icon: '★',
  },
  {
    year: '2025',
    title: '"Mero Ghar" — most personal release',
    description: 'A song I wrote missing home. The most vulnerable thing I\'ve put into the world. And somehow, the one that connected with people most.',
    tag: 'Milestone',
    icon: '♥',
  },
  {
