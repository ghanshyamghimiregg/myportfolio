...
const SOCIALS = [
  ...
  { name: 'TikTok', icon: 'tiktok', color: '#010101', href: 'https://www.tiktok.com/@ghanshyamghimiremusic' },
]
...
export function MusicStatement() {
  return (
    <section id="about" className="section-pad section-pad-x" style={{ backgroundColor: MUSIC.bg }} aria-label="About Ghanshyam Ghimire — musician and singer-songwriter">
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <div className="music-statement-grid">

          {/* Left: Photo — no floating card, clean crop */}
          <motion.div
          ...
          >
            ...
            >
              <img
                ...
                alt="Ghanshyam Ghimire performing as a singer-songwriter"
          ...
          >
            <blockquote
              style={{
                ...
                margin: '0 0 24px',
                padding: '0 0 0 20px',
                borderLeft: `2px solid ${MUSIC.accent}`,
              }}
            >
            ...
            >
              I tell stories through melodies — indie pop folk with touches of Nepali folk tradition. Singer-songwriter based in Nepal.
            </p>

            {/* Platform links — clean, no kicker label */}
              ...
              {SOCIALS.map(s => (
                <motion.a
                  ...
                  onMouseEnter={e => {
                    ...
                    e.currentTarget.style.backgroundColor = s.color + '10'
                  }}
                  onMouseLeave={e => {
                    e.currentTarget.style.borderColor = MUSIC.border
                    e.currentTarget.style.backgroundColor = MUSIC.card
                  }}
                >
